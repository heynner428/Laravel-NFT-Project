                    ...
                    <div class="col-12 col-md-7 col-lg-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mint_address" name="mint_address" placeholder="{{__('Mint Address')}}">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                        ...
                        <div class="create-new-page-box">
                            <div class="create-new-page-box-inner d-flex justify-content-between align-items-center">
                                <div>
                                    <button type="submit" class="theme-button1">{{__('Create Item')}}</button>
