...
class DashboardController extends Controller
{
    public function dashboard() {
        ...
        return view('user.dashboard', ['title' => __('Dashboard'), 'menu' => 'dashboard', 'service_sum' => $service_sum, 'purchase_sum' => $purchase_sum, 'deposit_sum' => $deposit_sum, 'withdraw_sum' => $withdraw_sum]);
    }
